...
internal class OpenAppChangedTrackerServiceTest {

    private lateinit var service:OpenAppChangedTrackerService

    private var currentCallback:OpenAppChangedCallback = mockk(relaxed = true)
    ...
    fun `send event in service expect service don't send event in ignoreList`() {
        ...
        every { currentCallback.params } returns OpenAppChangedTrackerParams.Builder()
    ...
    private class TestApp(val onGetCallback: () -> OpenAppChangedCallback) : Application(),DepsProvider {
